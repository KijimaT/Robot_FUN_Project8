...
void mu(){//モータ制御用変数port.write(1),scene = 2
    fill(#006400);
...
void mu2(){//モータ制御用変数port.write(2),scene = 3
    fill(#006400);
    ellipse(width/4,height/3,width*1/10,width*1/10);
    ellipse(width*3/4,height/3,width*1/10,width*1/10);
...
void egao(){//モータ制御用変数port.write(3),scene = 4
    fill(#006400);
...
void egao2(){//モータ制御用変数port.write(4),scene = 5
    fill(#006400);
...
void ok(){//モータ制御用変数port.write(5),scene = 1
    fill(#006400);
    textSize(75);
